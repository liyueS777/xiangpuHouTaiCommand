  ...
  <div>
    ...
    <ul class="configAdd">
      ...
      <li class="clearfix">
        <div>产业轴ID</div>
        <div>
          <el-input v-model="IndustryAxis" placeholder="请输入公司Id" disabled></el-input>
        </div>
      </li>
      <li class="clearfix">
        <div>位置顺序</div>
...
//        patternTitle:'公司名称',
    ...
    methods: {
      init(paramsItem){
        ...
        that.IndustryAxis = result.industryId;
